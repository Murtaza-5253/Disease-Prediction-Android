...
public class DiseasePredictor_Activity extends AppCompatActivity
{
    ...
    private void SearchDisease(String symptA, String symptB, String symptC, String symptD)
    {
        pd.show();
        txtDisease.setText("");
        String url = "https://diseasepredictor.000webhostapp.com/diseaseDemo.php?SymptA="+symptA+"&SymptB="+symptB+"&SymptC="+symptC+"&SymptD="+symptD;
    ...
    private void SearchDisease(String symptA, String symptB, String symptC)
    {
        pd.show();
        txtDisease.setText("");
        String url = "https://diseasepredictor.000webhostapp.com/diseaseDemo.php?SymptA="+symptA+"&SymptB="+symptB+"&SymptC="+symptC;
        JsonObjectRequest jsrqPD = new JsonObjectRequest(Request.Method.POST, url, null,
    ...
    private void SearchDisease(String symptA, String symptB)
    {
        pd.show();
        txtDisease.setText("");
        String url = "https://diseasepredictor.000webhostapp.com/diseaseDemo.php?SymptA="+symptA+"&SymptB="+symptB;
        JsonObjectRequest jsrqPD = new JsonObjectRequest(Request.Method.POST, url, null,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
    ...
    private void SearchDisease(String symptA)
    {
        pd.show();
        txtDisease.setText("");
        String url = "https://diseasepredictor.000webhostapp.com/diseaseDemo.php?SymptA="+symptA;
        JsonObjectRequest jsrqPD = new JsonObjectRequest(Request.Method.POST, url, null,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
    ...
    {
        SymptomA.clear();
        String url = "https://diseasepredictor.000webhostapp.com/PreSymA.php";
...
//                        Log.d("Error",""+error.getMessage().toString());
    ...
    public void symB(String SympA)
    {
        ...
        String url = "https://diseasepredictor.000webhostapp.com/PreSymB.php?SymptomA="+SympA;
    ...
    public void symC(String SympB)
    {
        SymptomC.clear();
        pd.show();
        String url = "https://diseasepredictor.000webhostapp.com/PreSymC.php?SymptomB="+SympB;
    ...
    public void symD(String SympC)
    {
        SymptomD.clear();
        pd.show();
        String url = "https://diseasepredictor.000webhostapp.com/PreSymD.php?SymptomC="+SympC;
    ...
    public void symE(String SympD)
    {
        SymptomE.clear();
        pd.show();
        String url = "https://diseasepredictor.000webhostapp.com/PreSymE.php?SymptomD="+SympD;
    ...
    private void SearchDisease(String symptA, String symptB,String symptC,String symptD,String symptE)
    {
        pd.show();
        txtDisease.setText("");
        String url = "https://diseasepredictor.000webhostapp.com/diseaseDemo.php?SymptA="+symptA+"&SymptB="+symptB+"&SymptC="+symptC+"&SymptD="+symptD+"&SymptE="+symptE;
        JsonObjectRequest jsrqPD = new JsonObjectRequest(Request.Method.POST, url, null,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
